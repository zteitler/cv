...
%\begin{description}
%\item[] Fall 2001: Precalculus
%\item[] Fall 2002: Calculus I
%\item[] Fall 2003: Calculus II
%\item[] Fall 2004: Calculus II
%\end{description}
%
%\item[Southeastern Louisiana University: ] \hfill
%\begin{description}
%\item[] Fall 2005: Calculus I, College Algebra (two sections)
%\item[] Spring 2006: Calculus I, College Algebra
%\item[] Fall 2006: Calculus II, Trigonometry
%\item[] Spring 2007: Calculus I, Complex Variables
%\end{description}
%
%\item[Texas A\&M University: ] \hfill
%\begin{description}
%\item[] Fall 2007: Business Mathematics I (Finite Math) (two sections)
%\item[] Spring 2008: Calculus II
%\item[] Fall 2008: Topics in Applied Mathematics I (Linear Algebra) (two sections)
%\item[] Spring 2008: Calculus II
%\item[] Fall 2009: Calculus II (two sections)
%\item[] Spring 2010: Calculus II
%\end{description}
%
%\item[Boise State University: ] \hfill
%\begin{description}
%\item[] Fall 2010:
%  \begin{description}
%  \item[] Introduction to Discrete Mathematics (4 credit hours, 25 students)
%  \end{description}
%\item[] Spring 2011:
%  \begin{description}
%  \item[] Calculus I (4 credit hours, 36 students)
%  \item[] Foundations of Geometry (3 credit hours, 27 students)
%  \end{description}
%\item[] Fall 2011:
%  \begin{description}
%  \item[] Introduction to Discrete Mathematics (4 credit hours, 25 students)
%  \item[] Abstract Algebra (3 credit hours, 10 students)
%  \end{description}
%\item[] Spring 2012:
%  \begin{description}
%  \item[] Introduction to Discrete Mathematics (4 credit hours, 25 students)
%  \item[] Advanced Algebra (3 credit hours, 9 students)
%  \end{description}
%\item[] Summer 2012:
%  \begin{description}
%  \item[] Multivariable and Vector Calculus (4 credit hours, 23 students)
%  \end{description}
%\item[] Fall 2012:
%  \begin{description}
%  \item[] Introduction to Discrete Mathematics (4 credit hours, 25 students)
%  \item[] Multivariable and Vector Calculus (4 credit hours, 46 students)
%  \item[] Advanced Calculus (4 credit hours, 12 students)
%  \end{description}
%\item[] Spring 2013:
%  \begin{description}
%  \item[] Advanced Analysis (3 credit hours, 5 students)
%  \end{description}
%\end{description}
%\end{description}
%%\end{multicols}
